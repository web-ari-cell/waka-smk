document.addEventListener("DOMContentLoaded", function () {
    ...
    // 11. FIXED SMART SMOOTH SCROLL (Tidak Memblokir Menu Pengalih Tampilan / View Switcher)
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            // Jika link memiliki kelas pemicu view switcher, jangan jalankan smooth scroll scroll global
            if (this.classList.contains('nav-view-trigger') || this.id === 'nav-jadwal-link') {
                return; 
            }
